...
<style>
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .s-offer_sent,.s-offer_accepted,.s-hired,.s-qualified { background: #e8f5e9; color: #1b5e20; }
  .s-offer_declined,.s-rejected,.s-not_qualified { background: #ffebee; color: #b71c1c; }
...
function renderModal(txn, data) {
  ...
  if (!data.found) {
    ...
    const stepMap = { submitted:1, screening:2, shortlisted:3, qualified:4, not_qualified:6, interview_scheduled:4, assessed:4, ranked:4, ranking_sent:4, offer_sent:5, offer_accepted:6, hired:6, offer_declined:6, rejected:6 };
    ...
    const badgeMap = {
      submitted:'s-submitted', screening:'s-screening', shortlisted:'s-shortlisted', qualified:'s-qualified', not_qualified:'s-not_qualified',
